...
import 'package:food_recipe/pages/beverage_list.dart';
import 'package:food_recipe/pages/diat_list.dart';
import 'package:food_recipe/pages/recipe_list.dart';
import 'package:food_recipe/pages/tips_list.dart';
                    ...
                    child: Padding(
                        ...
                        child: ListTile(
                          ...
                          onTap: () => Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => const DiatList())),
                        ))),
              )),
          StaggeredGridTile.count(
              crossAxisCellCount: 1,
