...
class _RecipeListState extends State<RecipeList> {
  ...
  fetchRecipes() async {
    ...
    if (response.statusCode == 200) {
      ...
      for (var item in items) {
        ...
        Recipe recipe = Recipe(recipeId, description);
        recipes.add(recipe);
      }
        isLoading = false;
    } else {
  ...
  Widget getCard(item) {
    // var recipeName = item['name']['first'] + " " + item['name']['last'];
    // var cookTime = item['dob']['age'];
    // var picture = item['picture']['large'];
    // Recipe recipe123 = Recipe("1", recipeName);
    return Card(
        child: Padding(
          ...
          children: <Widget>[
            ...
            Column(
              ...
              children: <Widget>[
                ...
                Text(
                  item.description.toString() + " min cook",
                  style: TextStyle(
                    fontSize: 16,
                  ),
                ),
